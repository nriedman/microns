import pandas as pd
from .mst_generation import generate_msts

# Load in desired synapse table, setting index_col to 0 because I always forget to ignore the index when I save csvs
# Note: Replace '23P_corner_95.csv' with your actual synapse dataset file
# synapse_df = pd.read_csv('../data/sample_datasets/23P_corner_95.csv', index_col=0)
...
# msts, _ = generate_msts(synapse_df, cells_df)
